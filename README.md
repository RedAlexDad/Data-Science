...
- [Создание 3D-моделей из LiDAR](/3D-models/README.md)

### Кластеризация данных измерений гибридного сопроцессора 

ноутбук [Знакомство с Qiskit](/quantum/Qiskit_handbook.ipynb)

### Анализ данных с помощью эмулятора с ROS для робота

[Репозиторий с проектом](https://github.com/iu5git/robot)
...
ноутбук [Обнаружение объектов](/stars-Yolo/stars-Yolo.ipynb) в датасете DeepSpace
